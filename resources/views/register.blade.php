                ...
                <form action={{ route('UserRegister') }} method='POST' class="mt-5"
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <input name='username' type="text" class="form-control form-control-custom"
                                id="inputUsername" placeholder="Username">
                        </div>
                        <div class="form-group">
                            <label for="inputEmail">Email</label>
                            <input name='email' type="email" class="form-control form-control-custom"
                                id="inputEmail" placeholder="abc@abc.com">
                        </div>
                    </div>
                ...
                <div class="row mt-5">
                    <div class="col-12 text-center">
                        <p>Already have an account? <a href="/login"
                                style="text-decoration: none; font-weight: bold; color: #F76D3B">Login</a></p>
                    </div>
                </div>
            </div>
        </div>
        <div class="col-7">
            <img src="https://github.com/nathrizandi/brainery/blob/main/public/assets/brain8.png?raw=true"
                style="width: 70%; margin-left: 7vw">
        </div>
    </div>
