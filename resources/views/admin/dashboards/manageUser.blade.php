...
@section('Content')
                            ...
                            <td>
                                <div class="d-flex flex-row justify-content-between btn-group py-2 gap-2" role="group"
                                    ...
                                    <button type="button" class="btn btn-sm btn-edit" data-bs-toggle="modal"
                                        data-bs-target="#EditCourse">EDIT</button>
    ...
    <!-- Modal Edit -->
    {{-- <div class="modal fade" id="EditUser" tabindex="-1" aria-labelledby="EditCourseLabel" aria-hidden="true">
        <div class="modal-dialog modal-xl modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
            <h1 class="modal-title fs-5" id="EditUserLabel">Edit Course</h1>
